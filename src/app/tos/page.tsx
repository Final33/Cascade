      ...
      <div className="px-48 py-12">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Prepsy, the software
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to C2C Prep, 42908 Southview Manor 
                Dr, Ashburn, VA 20148.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Prepsy, accessible from{" "}
                <a
                  href="prepsy.ai"
          ...
          <ul>
            <li>By email: aarnavtrivedi@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
