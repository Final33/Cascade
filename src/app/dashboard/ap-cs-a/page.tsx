...
// Note: The course ID 'cs-a' should match the ID used in your CourseSelector and potentially CourseContext/data sources.
export default function DashboardPage() {
  const [selectedCourse, setSelectedCourse] = useState("cs-a")
    ...
    <div className="min-h-screen bg-background">
      <div className="container space-y-6 p-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">AP Computer Science A</h1>
            <p className="text-muted-foreground">Master Java programming with AI-powered practice and real exam questions</p>
          </div>
        ...
        <section>
          <div className="grid gap-6 md:grid-cols-3">
            {/* Note: DBQ might not be applicable to CS A. Adjust card types as needed. */}
            <AIPracticeCard
